...
import copper.controllers.webapps.EditWebAppController;
...
public class EditWebAppView
{
    ...
    public void getWindow(WebApp obj, WebAppsController wObj)
    {
        ...
        try
        {
            ...
            if(Configurations.getConfig("theme").equals("dark"))
            {
                loader = new FXMLLoader(getClass().
                		getResource("/copper/views/webapps/EditWebAppViewDark.fxml"));
            }else
            {
                loader = new FXMLLoader(getClass().
                		getResource("/copper/views/webapps/EditWebAppView.fxml"));
            }
            root = loader.load();

            EditWebAppController ctrl = loader.getController();
        ...
        window.setTitle("Edit - " + obj.getAppName());
